...
import static com.github.himeraoO.mrtb.command.AbstractCommandTest.prepareUpdate;
import static com.github.himeraoO.mrtb.command.CommandName.REMOVE_GROUP_SUB;
import static java.util.Collections.singletonList;

@DisplayName("Unit-level testing for DeleteGroupSubCommand")
class RemoveGroupSubCommandTest {
    ...
    public void init() {
        ...
        command = new RemoveGroupSubCommand(sendBotMessageService, groupSubService, telegramUserService);
    }
    ...
    public void shouldProperlyReturnEmptySubscriptionList() {
        //given
        Long chatId = 23456L;
        Update update = prepareUpdate(chatId, REMOVE_GROUP_SUB.getCommandName());
    ...
    public void shouldRejectByInvalidGroupId() {
        //given
        Long chatId = 23456L;
        Update update = prepareUpdate(chatId, String.format("%s %s", REMOVE_GROUP_SUB.getCommandName(), "groupsubid"));
        TelegramUser telegramUser = new TelegramUser();
        GroupSub gs1 = new GroupSub();
        gs1.setId(123);
        gs1.setTitle("GS1 Title");
    ...
    public void shouldProperlyDeleteByGroupId() {
        ...
        Update update = prepareUpdate(chatId, String.format("%s %s", REMOVE_GROUP_SUB.getCommandName(), groupId));
